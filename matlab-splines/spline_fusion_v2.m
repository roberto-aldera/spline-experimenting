...
% Roberto Aldera - 18 November 2019
clc;clear
...
T = {T0; T0; T0; T0; T0; T0; T0; T0; T0; T0; T0}; % pretending the transforms are all the same for now
...
for i = 1:num_intervals
    ...
    t = linspace(T_world{i+2}(1,4),T_world{i+3}(1,4),5);
    plot(t,polyval(order_1_pred,t),'--o','Color',[0 1 0],'Linewidth',2);
    plot(t,polyval(order_2_pred,t),'--o','Color',[1 0 1],'Linewidth',2);
